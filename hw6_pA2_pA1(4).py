...
def play_game(turns, ply_threshold):
    ...
    total_game = 0
    prob_list = []
    stock_num = 3  # Number of Stocks player A buys
...
if __name__ == '__main__':
    ...
    sd = 0
    for i in range(10):
        prob_list = play_game(7, 160)
        all_values.append(prob_list)
            # print the plot
        # calculate the confidence intevral
    ...
    print(all_values_mean[0], all_values_mean[1])
